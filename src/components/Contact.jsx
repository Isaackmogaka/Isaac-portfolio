...
const contactLinks = [
  ...
  {
    label: 'Email',
    value: 'isaacmogaka2016@gmail.com',
    href: 'https://mail.google.com/mail/?view=cm&to=isaacmogaka2016@gmail.com&su=Hey Isaac — Let\'s Work Together',
    icon: (
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <p className="font-mono text-sm text-gray-400 leading-relaxed">
              I'm currently open to fullstack roles and freelance projects.
